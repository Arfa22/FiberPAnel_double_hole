...
// Generate random positions within the 10 cm x 10 cm area
      xPos = (2.0 * G4UniformRand() - 1.0) * 25* cm;  // Random x position within the square (±10 cm)
      yPos = (2.0 * G4UniformRand() - 1.0) * 25* cm;  // Random y position within the square (±10 cm)
